...
p1=np.cos(2*np.pi*10*t+np.pi/5) #   опорный косинус в приемнике
...
plt.figure(8)
plt.title('Cигнал на выходе фильтра cos')
plt.plot(rcf)
plt.figure(9)
...
plt.xlabel('Длительность символа [с]')
plt.ylabel('Амплитуда символа')
plt.title('Cигнал на выходе фильтра sin')
