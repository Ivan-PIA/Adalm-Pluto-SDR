...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._tune_range = Range(88, 110, 0.1, 100, 200)
        ...
        self.iio_pluto_source_0.set_frequency(int(1e6*tune))
    ...
    def set_tune(self, tune):
        self.tune = tune
        self.iio_pluto_source_0.set_frequency(int(1e6*self.tune))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(int(1067e5), self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(int(1067e5), self.samp_rate/5)
